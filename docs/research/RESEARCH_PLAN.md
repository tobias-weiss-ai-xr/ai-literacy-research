...
| **2 — Extraction** (in progress) | Abstract screening done: 72/150 included, refilled to 25/RQ; evidence tables `rq1-5.md` created, 17 key studies pre-extracted; 109 rows await full-text extraction; **priority gap-cell shortlists pinned into `rq2.md`/`rq3.md`**; **17 gap-cell studies extracted as abstract-level rows (RQ2-26–33, RQ3-26–34) from `gap_analysis.md`** | `docs/research/extraction/*.md` + evidence tables | ≥ 80% of shortlist extracted |
