...
| Concept | Kind | Papers |
|----------|------|--------|
| training | curated | 1267 |
| language models | curated | 959 |
| large language | curated | 957 |
| Compliance | taxonomy | 909 |
| higher education | curated | 898 |
| Ai Literacy Construct | taxonomy | 848 |
| evaluation | curated | 736 |
| Generative Ai Skills | taxonomy | 734 |
| Attitudes Trust | taxonomy | 731 |
| Workforce Upskilling | taxonomy | 690 |
| Adoption Behavior | taxonomy | 680 |
| Learning Design | taxonomy | 658 |
| Assessment | taxonomy | 629 |
| Org Implementation | taxonomy | 629 |
| Program Evaluation | taxonomy | 625 |
| Teacher Ai Literacy | taxonomy | 586 |
| Ai Literacy Pedagogy | taxonomy | 547 |
| Professional Education | taxonomy | 461 |
| Higher Education | taxonomy | 437 |
| Roi Measurement | taxonomy | 423 |
| Lifelong Learning | taxonomy | 385 |
| implementation | curated | 379 |
| Sme Training | taxonomy | 375 |
| Critical Ai Literacy | taxonomy | 372 |
| K12 Education | taxonomy | 340 |
| ai act | curated | 275 |
| prompt engineering | curated | 265 |
| compliance | curated | 236 |
| digital transformation | curated | 228 |
| critical thinking | curated | 226 |
| digital literacy | curated | 176 |
| measurement | curated | 107 |
| agentic ai | curated | 85 |
| utaut | curated | 40 |
| technostress | curated | 15 |
| maturity model | curated | 6 |
| self-report | curated | 5 |
| objective measurement | curated | 1 |
| Survey | taxonomy | 0 |
| Method | taxonomy | 0 |
...
- Program Evaluation — 216 shared paper(s)
- evaluation — 177 shared paper(s)
- language models — 173 shared paper(s)
- large language — 160 shared paper(s)
- Learning Design — 138 shared paper(s)
- Compliance — 122 shared paper(s)
- Attitudes Trust — 92 shared paper(s)
- Workforce Upskilling — 85 shared paper(s)

### language models

- large language — 827 shared paper(s)
- Generative Ai Skills — 301 shared paper(s)
...
- language models — 827 shared paper(s)
- Generative Ai Skills — 322 shared paper(s)
...
- Ai Literacy Construct — 104 shared paper(s)
- Ai Literacy Pedagogy — 89 shared paper(s)
- Learning Design — 77 shared paper(s)
...
- higher education — 104 shared paper(s)
- large language — 48 shared paper(s)
- language models — 46 shared paper(s)
...
- large language — 215 shared paper(s)
- language models — 213 shared paper(s)
- training — 177 shared paper(s)
- Generative Ai Skills — 115 shared paper(s)
- Program Evaluation — 101 shared paper(s)
- Compliance — 54 shared paper(s)
- Attitudes Trust — 50 shared paper(s)
- prompt engineering — 46 shared paper(s)

### Generative Ai Skills

- large language — 322 shared paper(s)
- language models — 301 shared paper(s)
...
- higher education — 71 shared paper(s)
- evaluation — 39 shared paper(s)
- measurement — 29 shared paper(s)
...
- implementation — 58 shared paper(s)
...
- training — 216 shared paper(s)
- evaluation — 101 shared paper(s)
...
- higher education — 89 shared paper(s)
...
- training — 44 shared paper(s)
- language models — 28 shared paper(s)
- higher education — 26 shared paper(s)
...
- higher education — 34 shared paper(s)
- training — 22 shared paper(s)
- evaluation — 9 shared paper(s)
- digital literacy — 8 shared paper(s)
...
- Org Implementation — 58 shared paper(s)
- training — 50 shared paper(s)
- evaluation — 40 shared paper(s)
- higher education — 35 shared paper(s)
- large language — 33 shared paper(s)
- language models — 31 shared paper(s)
- Compliance — 31 shared paper(s)
- Teacher Ai Literacy — 22 shared paper(s)
...
- critical thinking — 96 shared paper(s)
- large language — 49 shared paper(s)
- language models — 48 shared paper(s)
- higher education — 38 shared paper(s)
- evaluation — 30 shared paper(s)
- implementation — 15 shared paper(s)
- training — 14 shared paper(s)
