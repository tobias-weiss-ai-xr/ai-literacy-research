...
BURST_KEYWORDS = [
    "agentic", "agent", "generative ai", "genai", "llm", "large language model",
    "chatgpt", "gpt-4", "ai literacy", "ai competence", "ai skills", "upskilling",
    "reskilling", "workforce", "employee", "sme", "small business", "eu ai act",
    "article 4", "compliance", "regulation", "prompt engineering", "prompting",
    "critical thinking", "self-efficacy", "trust", "acceptance", "readiness",
    "assessment", "evaluation", "kirkpatrick", "outcome", "measurement",
    "framework", "taxonomy", "continuum", "persona", "reliance", "avoidance",
    "training", "course", "workshop", "curriculum", "pedagogy", "k-12",
    "higher education", "university", "teachers", "lifelong learning",
    "self-directed", "tutor", "chatbot", "productivity", "transfer", "retention",
    "spaced repetition", "micro-learning", "case study", "barrier",
]
