#!/usr/bin/env python3
"""Discover AI-literacy research papers from the OpenAlex API (fallback/primary source).
...
def main():
    parser = argparse.ArgumentParser(description="Discover AI-literacy research papers from OpenAlex")
